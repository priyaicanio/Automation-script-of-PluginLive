...
public class DashboardPage extends BaseClass {
    ...
    @FindBy(xpath = "//h2[text()='Priya Corporate']")
    ...
    private WebElement instituteloginsuccessmsg;

    public WebElement getInstituteloginsuccessmsg() {
        return instituteloginsuccessmsg;
    }
    ...
    public String instituteloginSuccessMsg() {
        String text = getText(getInstituteloginsuccessmsg());
        return text;
    }

    public void SelectDrives() {
        click(getSelectDrives());
    }
