...
public class LoginPage extends BaseClass {
    ...
    public void institutelogin(String instituteuserName, String institutepassword) throws InterruptedException {
        implicitywait();
        refresh();
        Thread.sleep(2000);
        sendkeys(getTxtUserName(), instituteuserName);
        sendkeys(getTxtPassword(), institutepassword);
        click(getCheckboxTermsandCondition());
        click(getBtnLogin());
    }
