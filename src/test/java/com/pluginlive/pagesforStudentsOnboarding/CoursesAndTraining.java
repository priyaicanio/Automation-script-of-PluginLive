...
public class CoursesAndTraining extends BaseClass {
    ...
    public void coursesandtraining() throws InterruptedException {
     ...
     public void addcourseandtraining(String instituteName, String Coursestartmonth, String Coursestartyear,String Courseendmonth, String Courseendyear, String CourseName, String CourseDescription, String skill1, String skill2, String skill3) throws InterruptedException, AWTException {
        Thread.sleep(2000);
